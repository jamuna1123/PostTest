                    ...
                    <div class="card-body mt-3">
                        <table class="table table-striped fixed-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($albums->image)
                                        <a href="{{ asset('storage/images/resized/800px_' . basename($albums->image)) }}" data-fancybox="gallery"
                                            data-caption="{{ $news->title }}">
                                            <img src="{{ asset('storage/images/resized/100px_' . basename($albums->image)) }}"
