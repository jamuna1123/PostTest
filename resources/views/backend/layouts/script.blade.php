            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.querySelectorAll('.statuspost-toggle').forEach(toggle => {
                    toggle.addEventListener('click', function(e) {
                        ...
                        // Show confirmation modal
                        var modal = new bootstrap.Modal(document.getElementById('modal-statuspost-toggle'));
                        modal.show();
                    });
                });
                ...
                function updateStatus(id, status) {
                    fetch(`/post/update-status/${id}`, {
                        ...
                        .then(data => {
                            ...
                            // Hide the modal after update
                            var modal = bootstrap.Modal.getInstance(document.getElementById('modal-statuspost-toggle'));
                            modal.hide();
                        })
                        .catch(error => {
                            console.error('Error updating status:', error);
