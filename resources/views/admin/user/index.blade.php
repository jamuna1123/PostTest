                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <div class="d-grid gap-2 d-md-flex  mb-1">
                                    ...
                                    <button class="btn btn-secondary" id="applyUserBulkAction" data-bulk-action-url="{{ route('user.bulk-update-status') }}" data-delete-url="{{ route('user.bulk-delete') }}"> <i class="fas fa-check"></i>
                                        Apply</button>
                                </div>
                                </div>
                            </div> <!-- /.card-header -->
