            ...
            <div class="col-md-8">
                <div class="card card-primary mb-4">
                    ...
                    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="name" class="form-label"><strong>{{ __('Name') }}:<span class="text-danger">*</span></strong></label>
                            ...
                            <div class="mb-3">
                                <label for="email" class="form-label"><strong>{{ __('Email') }}:<span class="text-danger">*</span></strong></label>
                            ...
                            <div class="mb-3">
                                <label for="profile_image" class="form-label"><strong>{{ __('Profile Image') }}:</strong></label>
